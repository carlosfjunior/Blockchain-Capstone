...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        ...
        require(owner != address(0), "Original Address in invalid");
    ...
    function ownerOf(uint256 tokenId) public view returns (address) {
        ...
        require(owner != address(0), "Original Address in invalid or yet to be assigned");
        return owner;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(owner != address(0), "Original Address in invalid or yet to be assigned");
        require(msg.sender == owner || isApprovedForAll(owner, msg.sender), "Requester is not Authorized");
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        require(_exists(tokenId), "The token is not valid");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "Address must be assigned");
        require(!_exists(tokenId), "Token is already in use");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from,"requestor is not the owner");
...
contract CustomERC721Token is ERC721Metadata {
    ...
    string private _name = "CustomERC721Token";
